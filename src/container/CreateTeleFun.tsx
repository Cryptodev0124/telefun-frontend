...
const App = () => {
  ...
  const [accounts, setAccounts] = useState([
    { privateKey: '', address: '', balance: '', inputAmount: '', error: 'Enter Private Key' },
  ]);
  ...
  const addRow = () => {
    if (accounts.length < MAX_ROWS) {
      setAccounts([...accounts, { privateKey: '', address: '', balance: '', inputAmount: '', error: 'Enter Private Key' }]);
    }
  };
  ...
  const onTeleFunCreate = async () => {
    try {
      ...
      console.error(err)
      toast.error(
        'There is a problem with your TeleFun create. Please try again later'
      )
    }
  }
                ...
                <>
                  <section>
                    ...
                    <div className="flex flex-col justify-center items-center gap-[10px] bg-[#312185] rounded-[25px] py-[45px] px-3 sm:px-[25px]">
                      <div className="text-[#2fcdf3] w-[90%] text-[18px]">Token Info</div>
                      <>
                                ...
                                <div className="fairlaunch-allocation-buttons-container">
                                  <button
                                    ...
                                    style={
                                      maxWallet === 1
                                        ? {}
                                        : { background: 'transparent', color: '#2fcdf3', border: 'solid #2fcdf3 1px' }
                                    }
                                  >
                                    1%
                                  </button>
                            ...
                            <section className="inputPanel">
                              <section className="inputPanelHeader">
                                <div className="fairlaunch-allocation-buttons-container">
                                  ...
                                  >
                                    <img src={chainLogos[11155111]} className='w-8' />
                                  </button>
                                </div>
                              </section>
                            </section>
                        ...
                        <div className={`w-[90%] ${isChecked ? 'grid' : 'hidden'} grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4`}>
                          ...
                          <section className="flex flex-col gap-4">
                            <div className="LpBalance">
                              <p className="Text1">Tip: coin data cannot be changed after creation</p>
                            </div>
                          </section>
                        </div>
